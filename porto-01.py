...
fig1 = px.line(dfcirc, x="Ano", y='Valor',hover_data={"Ano"},color='Ativo',line_shape="spline",labels={"Valor": "Valor (xR$1000)","Ativo": "Ativos","Ano": "Exercício"})
fig1.update_xaxes(dtick=1)
fig1.update_layout(title='Circulante')

fig2 = px.line(dfncirc, x="Ano", y='Valor',hover_data={"Ano"},color='Ativo',line_shape="spline",labels={"Valor": "Valor (xR$1000)","Ativo": "Ativos","Ano": "Exercício"})
